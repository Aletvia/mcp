...
<h1 class="h2 ">Nueva solicitud</h1>
<div class="col">
	<button onclick="editar()" class="btn btn-success d-inline float-right" style="color:white;font-weight:bold"><i class="fa fa-plus"></i> Agregar solicitud</button>
</div>
</div>
<div>
<?php
...
action="<?= base_url() ?>index.php/Clientes/agregar_si" method="post">
			...
			<div class="tab-pane fade show active" id="sol" role="tabpanel" aria-labelledby="sol-tab">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						...
						<div class="row">
							<div style="margin-bottom: 15px" class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<input  onchange="calc()" value="<?= $rode ?>"  id="rode" name="rode" min="1000" max="2000" type="number" class="form-control input-sm" required  placeholder="">
							</div>
						</div>
					</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						...
						<div class="row">
							<div style="margin-bottom: 15px" class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<input value="<?= $interes ?>"  id="interest" name="interest" type="number" class="form-control input-sm" disabled  placeholder="">
								<input value="<?= $interes ?>"  id="interes" name="interes" type="hidden" >
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						...
						<div class="row">
							<div style="margin-bottom: 15px" class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<input value="<?= $interes+$rode ?>"  id="total" name="total" type="number" class="form-control input-sm" disabled  placeholder="">
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div style="margin-bottom: 15px" class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<select onchange="calc()" style="height:45px" id="time" name="time" class="form-control input-sm" required onchange="" >
									...
									for ($j=1;$j<31;$j++){
										?>
										<option value="<?= $j ?> días" <?php if($time==$j){?>selected<?php }?>> <?= $j ?> días</option>
									<?php }?>
								</select>
							</div>
						</div>
