...
<div style="margin-top:15px;margin-bottom:15px"  class="row">
	...
	<div class="col">
		<button onclick="editar()" class="btn btn-success d-inline float-right" style="color:white;font-weight:bold"><i class="fa fa-save"></i> Guardar cambios</button>
...
<div>
	...
	foreach ($cli as $u) {
		...
		<ul class="nav nav-tabs" id="myTab" role="tablist">
			<li class="nav-item">
				<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Personal</a>
			</li>
			<li class="nav-item">
		...
		action="<?= base_url() ?>index.php/Clientes/editar_c" method="post">
