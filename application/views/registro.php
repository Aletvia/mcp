  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="contenedor d-flex justify-content-center" >
			...
			<div class="contenedorForm " style="margin-top:-70px">
				...
				<div class="contenedorInputs d-flex justify-content-center flex-wrap">
					<form id="loginform" action="<?= base_url() ?>index.php/Welcome/cadastrar" method="post">
                            ...
                            <div style="margin-bottom: 25px" class="input-group center col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <span class="input-group-prepend">
											<div class="input-group-text bg-white border-right-0"><i class="fa fa-birthday-cake"></i></div>
										</span>										
                            ...
                            <!--div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-append"><i class="glyphicon glyphicon-globe"></i></span>
                            ...
                            <div class="input-group center col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                      <div class="checkbox">
                                        <label>
                                          <input id="acept_t_p" type="checkbox" required name="acept_t_p" value="1"> <label for="checkbox">Acepto<a href="#">Términos de servicio</a> y <a href="#">Políticas de privacidad</a></label>
                                        </label>
                                      </div>
                             </div>
	  ...
	  <h5 class="center col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div style="margin-bottom:50px;margin-top:20px" class="centered ">
