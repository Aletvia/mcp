    <!-- container -->
		...
		action="<?= base_url() ?>index.php/Microprestamos/editar_s" method="post">
								...
								<div class="row">
									...
									<div class="tab-pane fade show active" id="sol" role="tabpanel" aria-labelledby="sol-tab">
										...
										<div class="row">
											...
											<div style="margin-bottom: 15px" class="input-group  col-lg-6 col-md-6 col-sm-12 col-xs-12">
												<span class="input-group-prepend">
													<div style="font-weight:bold" class="input-group-text bg-white border-right-0">Cambiar estatus a&nbsp</div>
												</span>
												<select id="status" name="status" class="form-control input-sm" required>
													<option value="">Seleccione una opción</option>
													<option value="Pre-solicitud en espera">Pre-solicitud en espera</option>
													<option value="Pre-solicitud rechazada">Pre-solicitud rechazada</option>
													<option value="Pre-solicitud aprobada">Pre-solicitud aprobada</option>
													<option value="Solicitud en espera">Solicitud en espera</option>
													<option value="Solicitud rechazada">Solicitud rechazada</option>
													<option value="Solicitud aprobada">Solicitud aprobada</option>
													<option value="Préstamo en espera">Préstamo en espera</option>
													<option value="Rechazo de documentos">Rechazo de documentos</option>
													<option value="Préstamo realizado">Préstamo realizado</option>
													<option value="Préstamo al corriente">Préstamo al corriente</option>
									...
									<div class="tab-pane fade" id="dep" role="tabpanel" aria-labelledby="dep-tab">
													...
													<div style="margin-bottom: 15px" class="input-group  col-lg-7 col-md-7 col-sm-12 col-xs-12">
														...
														<div style="margin-bottom: 15px" class="input-group  col-lg-5 col-md-5 col-sm-12 col-xs-12">
															<span class="input-group-prepend">
																...
																<input value="<?= $u->tiempo_estimado ?>" id="estimated_t" name="estimated_t" type="text" class="form-control input-sm"  >
															</div>
														</div>
														<div class="row">
															<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
										...
										<?php }else{?>disabled<?php }?>
																		...
																		<div style="margin-bottom: 15px" class="input-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
																			<button   onclick="subir('Calendario')"  
																				type="button" id="registrar" style="font-weight:bold;width:100%" class="btn btn-secondary">
										...
										<?php }else{?>disabled<?php }?>
																				...
																				<div style="margin-bottom: 15px" class="input-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
																					<button   onclick="subir('Comprobante')"  
																						type="button" id="registrar" style="font-weight:bold;width:100%" class="btn btn-secondary">
																						<i class="fa fa-upload"></i>&nbspSubir</button>
																					</div>
																				</div>
